...
export default function SearchBar() {
    return (
            ...
            <div className="divide-x min-h-6 flex items-center tracking-[0.0125em] text-[14px] text-zinc-800 shadow-[0px_0px_4px_0px_rgba(0,0,0,0.07)] border border-zinc-900 rounded-full pt-[0.7rem] pb-[0.7rem] pr-2.5 pl-2 ">
