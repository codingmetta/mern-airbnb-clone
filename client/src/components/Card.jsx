...
export default function Card(props) {
    ...
    return (
        <div className="max-w-sm pb-3 leading-5  tracking-[0.03rem] text-[14.5px] bg-white rounded-xl  dark:bg-gray-800 dark:border-gray-700 ">
            <a href="#">
                <img className="w-[16.9rem] h-[16.2rem] object-cover rounded-xl" src={props.img} alt="" />
            </a>
