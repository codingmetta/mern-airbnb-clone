        ...
        <>
            <div className="max-w-full mx-auto dark:bg-gray-700 pt-6">
                <div className="flex items-center">
                    ...
                    <div className="flex flex-row space-x-10 font-medium text-xs antialiased text-gray-500">

                        <Link>
                            <button className="flex flex-col items-center border-white border-b-2 hover:text-black hover:border-gray-300 focus:text-black focus:border-black gap-2 pt-3">
